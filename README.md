...
Once that is done, go into the main directory, make sure you alter the message ur sending with your sender email, the subject line and the message content. Once this is done, just run `python send_emails.py` and you should be good!
